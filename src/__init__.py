"""Companion code exports for the Book 3 generative-model examples.

This module uses lazy imports so torch-dependent components load only when
needed. The Book 3 companion is centered on generative-model reference
implementations for VAEs, GANs, normalizing flows, and diffusion models.
"""
...
def __getattr__(name: str):
    """Lazy import for companion symbols."""
